...
# Diagnostic tool — does NOT count toward the 5 research tools frozen
# for v0.1 (see CLAUDE.md "Tools surface frozen at 5"). Revisit at the
# v0.1.0 release: keep as a diagnostic, or remove if the 5 tools cover
# the smoke-test need.
@mcp.tool()
